...
- The module assessment asks why to create an AI Impact Assessment, which Foundry capability mitigates harmful content at the safety-system level, and why to plan a phased delivery (SRC-170 L217–230); the teaching units answer: the Impact Assessment template documents potential harms (SRC-153 L229), guardrails are a safety-system mitigation (SRC-156 L230), and phased delivery gathers feedback and identifies problems before broad release (SRC-152 L227).
