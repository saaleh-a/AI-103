...
2. **Model discovery and deployment.** Prerequisites: Step 1. Read [[model-selection]], [[model-catalog]], [[model-benchmarks]], [[model-deployment-types]], [[model-playgrounds]]. Be able to choose a model family by modality and constraints, justify the choice with benchmarks, and describe deployment to an endpoint (SRC-89 L221–244; SRC-188 L215–219; SRC-39 L214–254; SRC-90 L217–240).
