...
|---|---|---|---|
| Foundry Agent Service | Managed platform for creating, hosting, scaling, securing, tracing, publishing, and tool-augmenting agents. (SRC-230 L255–274; SRC-232 L226–239) | You need managed agents, automatic tool calling, service-managed state, security, observability, publishing, or integration endpoints. (SRC-230 L267–273; SRC-232 L226–247) | The scenario asks mainly for provider-agnostic SDK code or explicit code-defined orchestration. (SRC-237 L218–232) |
...
| Direct Foundry publishing to Microsoft 365 | Publish a Foundry agent to Microsoft 365/Teams with generated Bot Service, package, and Entra app. (SRC-232 L226–237) | Agent logic remains in Foundry and the integration path is straightforward. (SRC-232 L237–239; SRC-209 L218–220) | Complex custom SSO, advanced middleware, or multi-environment deployment pipelines. (SRC-232 L239; SRC-5 L222–224) |
