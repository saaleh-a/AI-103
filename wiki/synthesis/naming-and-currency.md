...
area: corpus
source_ids: [SRC-2, SRC-10, SRC-12, SRC-24, SRC-41, SRC-42, SRC-45, SRC-48, SRC-49, SRC-51, SRC-89, SRC-96, SRC-97, SRC-102, SRC-108, SRC-119, SRC-122, SRC-124, SRC-177, SRC-179, SRC-180, SRC-183, SRC-184, SRC-189, SRC-191, SRC-228, SRC-230, SRC-231, SRC-233, SRC-234, SRC-236, SRC-240]
objectives: []
objective_gaps: []
tags: []
...
| Azure Language / Azure AI Language / Azure Language in Microsoft Foundry Tools | The Learn unit title is Azure Language in Microsoft Foundry Tools and an episode says "Azure AI Language"; language MCP pages expose language detection, NER and PII through the Language MCP server. | Azure Language unit (SRC-12 L211–237); text-analysis MCP episode, whose agent identifies PII entities through the MCP tools (SRC-45 L17–19; SRC-45 L299–317); Language MCP connection unit (SRC-24 L209–265). | **Inference:** Do not assume every language capability is an LLM task; corpus often treats it as a Foundry Tool or MCP server capability (SRC-12 L211–237; SRC-24 L209–265). |
| Foundry Toolkit for VS Code / Microsoft AI Toolkit / AI Toolkit | A tools unit names Foundry Toolkit; an episode caption says AI Toolkit, and the plan-and-prepare episode recommends the "Microsoft AI Toolkit" for Visual Studio Code. | Developer tools unit (SRC-51 L212–238); text-analysis episode says AI Toolkit (SRC-10 L499–500); plan-and-prepare episode (SRC-183 L928–934). | **Stale-risk:** Toolkit names and VS Code extensions are susceptible to product rename and UI drift (SRC-51 L212–238; SRC-10 L499–500). |
...
| Toolkit and portal labels are inconsistent across Learn and episodes. | SRC-51 L212–238; SRC-10 L499–500; SRC-183 L928–934 |
...
- SRC-45 — [[src-45-develop-text-analysis-agent-azure-language-mcp-server-episode]] — text-analysis MCP episode: "the Azure AI Language Service".
