...
| Azure Language / Azure AI Language / Azure Language in Microsoft Foundry Tools | The Learn unit title is Azure Language in Microsoft Foundry Tools and an episode says "Azure AI Language"; language MCP pages expose language detection, NER and PII through the Language MCP server. | Azure Language unit (SRC-12 L211–237); text-analysis MCP episode (SRC-45 L17–19); Language MCP connection unit (SRC-24 L209–265). | **Inference:** Do not assume every language capability is an LLM task; corpus often treats it as a Foundry Tool or MCP server capability (SRC-12 L211–237; SRC-24 L209–265). |
