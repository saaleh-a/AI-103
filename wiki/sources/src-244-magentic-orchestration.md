...
Magentic orchestration is a manager-driven multi-agent pattern for complex open-ended tasks whose path is not predetermined. (SRC-244 L220, L224–230) A Magentic manager maintains context, tracks progress, builds a task ledger, delegates to specialists, and adapts the workflow in real time. (SRC-244 L220–221)

## Key claims

- Magentic orchestration uses a dedicated manager to coordinate specialized agents. (SRC-244 L220)
- The manager chooses the next agent from evolving context, progress, and capabilities. (SRC-244 L220)
- The manager maintains shared context, tracks progress, and adapts the workflow in real time. (SRC-244 L221)
- A dynamic task ledger records goals, subgoals, and execution plans. (SRC-244 L221)
...
The manager plans, delegates, tracks progress, and revises the approach as new information emerges. (SRC-244 L220–221, L245) The pattern focuses on documenting the approach as well as the final solution. (SRC-244 L221) This makes it heavier than simpler orchestration patterns and explicitly trades speed for planning. (SRC-244 L231–236)
...
- **Magentic orchestration** — a flexible manager-led pattern for open-ended multi-agent work. (SRC-244 L220–221)
- **Magentic manager** — the coordinator that selects agents, tracks progress, and adapts the workflow. (SRC-244 L220–221)
- **Task ledger** — a dynamic record of goals, subgoals, and execution plans. (SRC-244 L221)
...
- [[src-231-understand-agent-orchestration]] introduces Magentic as a manager-driven approach for open-ended tasks. (SRC-231 L254; SRC-244 L220–245)
- [[src-242-group-chat-orchestration]] is nearby; Magentic is more planning- and manager-led. (SRC-242 L220–265; SRC-244 L220–245)
...
- [[magentic-orchestration]] — the page's core pattern. (SRC-244 L220–245)
- [[multi-agent-orchestration]] — the pattern coordinates specialized agents. (SRC-244 L220–230)
