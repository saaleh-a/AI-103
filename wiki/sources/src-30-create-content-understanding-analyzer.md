...
- Developers can explicitly label fields in documents to improve analyzer performance. (SRC-30 L222)
...
- **Analyzer** — the Content Understanding artifact trained to extract specific information from a particular type of content. (SRC-30 L216)
...
- [[azure-content-understanding]] — analyzers are the core Content Understanding solution artifact. (SRC-30 L216)
- [[microsoft-foundry]] — projects and analyzer endpoints are associated with Microsoft Foundry resources. (SRC-30 L227; SRC-30 L239–241)
