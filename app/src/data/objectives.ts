...
export const OBJECTIVES: ObjectiveRecord[] = [
  ...
  { id: 'P09', domain: PLAN, skill: 'Manage, monitor, and secure AI systems', objective: 'Manage quotas, scaling, rate limits, and cost footprints for model and agent workloads', taughtBy: ['model-deployment'], gaps: [{ kind: 'authoring', note: 'Deployment types and reserved throughput are taught. Token budgets, rate-limit backoff and cost monitoring appear only as a practice list (source 223) and have no lesson yet.' }] },
  ...
  { id: 'P15', domain: PLAN, skill: 'Implement responsible AI across generative AI and agentic systems', objective: 'Implement auditing through trace logging, provenance metadata, and approval workflows', taughtBy: ['agents-workflows', 'agents-mcp', 'agents-workflow-recovery', 'foundry-iq'] },
  ...
  { id: 'G14', domain: GEN, skill: 'Optimize and operationalize generative AI systems', objective: 'Implement model reflection, chain-of-thought evaluations, and self-critique loops', taughtBy: ['prompt-engineering', 'agents-handoff-group-chat'], gaps: [{ kind: 'authoring', note: 'Maker-checker review and prompt-level reasoning are taught; reflection loops are only briefly sourced (sources 177 and 178). Study them through observable traces and evaluations, never hidden chain-of-thought.' }] },
  ...
  { id: 'V07', domain: VISION, skill: 'Design and implement multimodal understanding workflows', objective: 'Configure apps to produce concise or detailed captions for single or multiple images', taughtBy: ['vision-chat'] },
  ...
  { id: 'V13', domain: VISION, skill: 'Design and implement multimodal understanding workflows', objective: 'Implement solutions that identify objects, components, or regions within images or video', taughtBy: ['content-understanding-images', 'vision-chat'], gaps: [{ kind: 'authoring', note: 'Grounding extracted values to image regions and asking about visible objects are taught; locating objects in video has no lesson.' }] },
  ...
  { id: 'V15', domain: VISION, skill: 'Implement responsible AI for multimodal content', objective: 'Detect and mitigate indirect prompt injection by using embedded text in images', taughtBy: ['vision-chat', 'responsible-ai-guardrails'] },
  ...
  { id: 'T02', domain: TEXT, skill: 'Apply language model text analysis', objective: 'Configure detection of sentiment, tone, safety issues, and sensitive content', taughtBy: ['language-overview', 'language-pii', 'responsible-ai-guardrails'] },
  ...
  { id: 'I02', domain: EXTRACT, skill: 'Build retrieval and grounding pipelines', objective: 'Configure semantic search, hybrid search, and vector search for grounding', taughtBy: ['search-query', 'rag-fundamentals', 'foundry-iq-data-sources'] },
