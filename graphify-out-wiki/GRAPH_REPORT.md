...
8. `Speech and language options compared` - 44 edges
9. `Retrieval-augmented generation (RAG)` - 41 edges
10. `Model selection` - 39 edges
...
### Community 0 - "Models, Evaluation, Safety and Exam Scope"
Cohesion: 0.14
...
### Community 5 - "Foundry Platform, SDKs and Naming"
Cohesion: 0.27
...
- **Why does `Decision boundaries — confusable technologies` connect `Agents, Tools and APIs` to `Models, Evaluation, Safety and Exam Scope`, `Speech, Voice and Keyless Auth`, `Workflows, Orchestration and A2A`, `Information Extraction`, `Foundry Platform, SDKs and Naming`, `Retrieval, Search and RAG`, `MCP and Azure Language`, `Publishing, Entra ID and Microsoft 365`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `Microsoft Foundry` connect `Foundry Platform, SDKs and Naming` to `Models, Evaluation, Safety and Exam Scope`, `Agents, Tools and APIs`, `Speech, Voice and Keyless Auth`, `Workflows, Orchestration and A2A`, `Information Extraction`, `Retrieval, Search and RAG`, `MCP and Azure Language`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `Master synthesis — whole AI-103 architecture` connect `Models, Evaluation, Safety and Exam Scope` to `Agents, Tools and APIs`, `Speech, Voice and Keyless Auth`, `Workflows, Orchestration and A2A`, `Information Extraction`, `Foundry Platform, SDKs and Naming`, `Retrieval, Search and RAG`, `MCP and Azure Language`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Should `Models, Evaluation, Safety and Exam Scope` be split into smaller, more focused modules?**
  _Cohesion score 0.14126126126126126 - nodes in this community are weakly interconnected._