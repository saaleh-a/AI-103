> Source: https://learn.microsoft.com/en-gb/training/modules/develop-ai-agent-with-semantic-kernel/5-exercise

Exercise - Develop an Azure AI agent with the Microsoft Agent Framework SDK - Training | Microsoft Learn
