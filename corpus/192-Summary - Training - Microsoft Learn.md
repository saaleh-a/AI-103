> Source: https://learn.microsoft.com/en-gb/training/modules/create-speech-enabled-apps/9-summary
...
To learn more about the Azure Speech, refer to the Azure Speech in Foundry Tools documentation.
Module incomplete:
