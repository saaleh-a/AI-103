> Source: https://learn.microsoft.com/en-gb/training/modules/develop-generative-ai-audio-apps/3b-develop-speech-app

Synthesize speech - Training | Microsoft Learn
...
Choose a speech-capable model 3 min: Completed
Transcribe speech 3 min: Completed
Synthesize speech 3 min: Completed
Exercise - Use speech-capable generative AI models 30 min: Completed
...
gpt-4o-mini-tts
Note
Model availability varies by region. Review the model regional availability table in the Microsoft Foundry documentation.
...
Python
Copy
Next unit: Exercise - Use speech-capable generative AI models
Previous Next
