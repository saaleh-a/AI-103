> Source: https://learn.microsoft.com/en-gb/training/modules/discover-agents-with-a2a/6-exercise

Exercise - Connect to remote Azure AI Agents with the A2A protocol - Training | Microsoft Learn
