> Source: https://learn.microsoft.com/en-gb/training/modules/create-speech-enabled-apps/5-audio-format-voices
...
Next unit: Use Speech Synthesis Markup Language
Previous Next
