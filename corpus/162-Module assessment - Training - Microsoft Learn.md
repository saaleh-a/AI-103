> Source: https://learn.microsoft.com/en-gb/training/modules/prepare-azure-ai-development/8-knowledge-check
...
Completed 200 XP
3 minutes
Which web portal should you use to work with assets in a Microsoft Foundry project? [-] 0
The Azure portal [-] 1
Microsoft Copilot [-] 2
The Microsoft Foundry portal
2.
Which component of Microsoft Foundry provides pre-built services for common AI tasks? [-] 0
Foundry Tools [-] 1
Foundry Models [-] 2
Foundry IQ
3.
Which extension should you use in Visual Studio Code to work with Foundry projects? [-] 0
