> Source: https://learn.microsoft.com/en-gb/training/modules/analyze-content-ai/06-knowledge-check
...
Completed 200 XP
3 minutes
What kinds of AI solution is Azure Content Understanding designed to help you build? [-] 0
Chatbots that automatically translate between multiple spoken and written languages. [-] 1
Analyzers that extract information from documents, images, videos, and audio files. [-] 2
Image generators that create visualizations based on descriptions.
2.
Which graphical tool should you use to create an Azure Content Understanding project? [-] 0
Microsoft Visual Studio. [-] 1
Azure Machine Learning studio. [-] 2
Content Understanding Studio.
3.
What should you define for the information you want to extract from content? [-] 0
A schema. [-] 1
An index. [-] 2
A cluster.
Submit answers
