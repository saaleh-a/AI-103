> Source: https://learn.microsoft.com/en-gb/training/modules/develop-ai-agent-with-semantic-kernel/4-add-plugins-to-agent

Add tools to Azure AI agent - Training | Microsoft Learn
